...
describe('Models: ', function() {
  ...
  describe('User Model ', function() {
    ...
    it('should return data in the correct format when correct key is passed.',
      function(done) {
        userModel.findOne({email: 'adityaberasia@gmail.com'},
  ...
  describe('Mentor Model ', function() {
    it('should return no data when incorrect key is passed.', function(done) {
      userModel.findOne({email: 'nurture@example.com'},
        function(err, mentorInfo){
          expect(err).to.be.null;
    ...
    it('should return data in the correct format when correct key is passed.',
      function(done) {
        mentorModel.findOne({email: 'adityaberasia@gmail.com'},
          function(err, mentorInfo){
