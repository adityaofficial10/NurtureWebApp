...
const impacts = [
    [
        ...
        'https://static.wixstatic.com/media/nsplsh_41456154556e766e65696b~mv2_d_5184_3456_s_4_2.jpg/v1/fill/w_375,h_375,fp_0.50_0.50,q_80,usm_0.66_1.00_0.01/nsplsh_41456154556e766e65696b~mv2_d_5184_3456_s_4_2.webp',
    ],
    [
        'Women',
        ...
        'https://static.wixstatic.com/media/nsplsh_313746525455375871636b~mv2.jpg/v1/fill/w_375,h_375,fp_0.50_0.50,q_80,usm_0.66_1.00_0.01/nsplsh_313746525455375871636b~mv2.webp',
    ],
    [
        'Mental Health',
        ...
        'https://static.wixstatic.com/media/nsplsh_626f335348503538433367~mv2_d_9000_6001_s_4_2.jpg/v1/fill/w_375,h_375,fp_0.50_0.50,q_80,usm_0.66_1.00_0.01/nsplsh_626f335348503538433367~mv2_d_9000_6001_s_4_2.webp',
    ],
];
                            ...
                            <div className='card mb-3'>
                                <div className='row no-gutters'>
                                    <div
                                        className={
                                            'col-md-3 ' +
                                            (i % 2 === 0 ? 'order-md-0' : 'order-md-1')
                                        }
                                    >
                                        <img
                                            src={impact[2]}
                                            height='200px'
                                            className={i % 2 === 1 ? 'float-md-right' : ''}
                                        />
                                    </div>
                                    <div className='col-md-9 px-3'>
                                        <div className='card-body'>
                                            <h3 className='card-title'>{impact[0]}</h3>
