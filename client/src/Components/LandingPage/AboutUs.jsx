...
export default function AboutUs() {
    return (
        ...
        // [] - Add in animations
        // [] - Make it more pro
        <div className='p-sm-5' id='about-us' name='about-us'>
            <div className='container'>
                <div className='row'>
                    <div className='col-md order-md-2 p-0 wow fadeInRight' id='about-us-img'>
                    ...
                    <div className='col-md order-md-1 py-3 px-5 mr-md-5 wow fadeInLeft' id='about-us-content'>
